...
verification paths. The remaining V1 priority is connecting schedule commitment and Control
execution to the selected request, then connecting product/progress back to that same request.
